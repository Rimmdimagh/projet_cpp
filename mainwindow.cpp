    ...
    ui(new Ui::MainWindow)
{
    ...
    QSound::play("C:/intgration2/intg/welcome.wav");
    //QTimer * timer = new QTimer(this);
    timer->setSingleShot(true);
    timer->setInterval(1500);
    //timer->start();
    connect(timer, &QTimer::timeout, []() { QSound::play("C:/intgration2/intg/hello.wav"); });
   ...
   ui->tab_condidature_2 ->setModel(Ctmp.afficher());
   ...
   QObject::connect(ui->pushButton_18,SIGNAL(clicked()),this, SLOT (page15Widget()) );
/*********************************MAINTENANCE****************************************/
   setFixedSize(1200,1500);



      QFile file("C:/intgration2/intg/historique.txt");
    ...
    //quantite
      ...
      ui->rech->setValidator(new QRegExpValidator(QRegExp("[a-z-A-Z]+"),this));
ui->id_con->setValidator(new QRegExpValidator(QRegExp("[a-z-A-Z]+"),this));
ui->pass_con->setValidator(new QRegExpValidator(QRegExp("[a-z-A-Z]+"),this));
ui->statu->setValidator(new QRegExpValidator(QRegExp("[a-z-A-Z]+"),this));
      //COMBO BOX marque
...
void MainWindow::on_pb_Ajouter_clicked()
{
    ...
    QMediaPlayer *player = new QMediaPlayer;
               player->setMedia(QUrl::fromLocalFile("C:/intgration2/intg/button.wav"));
...
void MainWindow::on_qrcodegen_2_clicked()
{
    ...
    QMediaPlayer *player = new QMediaPlayer;
                   player->setMedia(QUrl::fromLocalFile("C:/Users/manou/OneDrive/Desktop/intg/button.wav"));
                   player->setVolume(2000);
                   player->play();
...
void MainWindow::page15Widget()
{
    QObject::connect(ui->pushButton_18,SIGNAL(clicked()),this,SLOT(page1Widget()) );
...
void MainWindow::on_pushButtonAjouter_2_clicked()
{
    ...
    QFile file("C:/intgration2/intg/historique.txt");//declaration d'un fichier
...
void MainWindow::on_send_mail_3_clicked()
{
    Smtp* smtp = new Smtp("aura.forgetPass@gmail.com","Service100a","smtp.gmail.com",465);
           ...
           smtp->sendMail("aura.forgetPass@gmail.com",ui->rcpt_3->text(),ui->subject_3->text(),ui->msg_3->toPlainText());
...
{
    QMediaPlayer *player = new QMediaPlayer;
              player->setMedia(QUrl::fromLocalFile("C:/Users/manou/OneDrive/Desktop/intgbutton.wav"));
              player->setVolume(2000);
              player->play();
...
void MainWindow::on_seconnecter_clicked()
{
    ...
    QString status=ui->statu->text();
    ui->id_con->setStyleSheet("color: black");
    ui->pass_con->setStyleSheet("color: black");

    ui->statu->setStyleSheet("color: black");

//ke admin admin
    if(id_connexion == "admin" && password_connexion == "admin" && status=="ADMIN")
    {

        QSound::play("C:/intgration2/intg/accepted.wav");
...
ui->statu->clear();
    ...
    else  if(id_connexion == "taher" && password_connexion == "guerfala" && status=="feedback")
    {

        ui->stackedWidget->setCurrentIndex(1);


        ui->configuration->setDisabled(false);
...
ui->statu->clear();
    ...
    else if(id_connexion != "admin" && password_connexion == "admin")
    {
        ...
        QSound::play("C:/intgration2/intg/voice-access-denied.wav");
...
void MainWindow::on_pb_ajouter_4_clicked()
{
    ...
    int identifiant=ui->le_identifiant_2->text().toInt();
    QString nomt=ui->le_nomt_2->text();
    QString specialite=ui->la_specialite_2->text();
    QString niveauc=ui->le_niveauc_2->text();
    condidature C(identifiant,nomt,specialite,niveauc);
        bool test=C.ajouter();
  //MainWindow w;
 if(test)
  {ui->tab_condidature_2 ->setModel(C.afficher());
      ...
      QMessageBox::critical(nullptr, QObject::tr("database is not open"),
                  QObject::tr("echec d ajout.\n"
                              "Click Cancel to exit."), QMessageBox::Cancel);
 ui->le_nomt_2->clear();
 ui->le_identifiant_2->clear();
 ui->le_niveauc_2->clear();
 ui->la_specialite_2->clear();
...
void MainWindow::on_modifier_3_clicked()
{
    ...
    QMediaPlayer *player = new QMediaPlayer;
     ...
     QString specialite=ui->lineEdit_spec_2->text();
    ...
    condidature C1(id,nom,specialite,niveau);
     ...
     if (test)
         //[☺]
        {
         ui->tab_condidature_2->setModel(C1.afficher());
...
void MainWindow::on_pb_supprimer_4_clicked()
{
    ...
    C.setidentifiant(ui->leidentifiantsupp_2->text().toInt());
...
void MainWindow::on_trier_2_clicked()
{
    ...
    QMessageBox msgBox;
        if(test){
            ...
            ui->tab_condidature_2->setModel(C.triparspecialite());
        }
            else
...
void MainWindow::on_rechercher_2_clicked()
{
    ...
    QString nomt=ui->ln_rechercher_nomt_2->text();
        ...
        ui->tab_rech_2->setModel(model);

        qDebug() <<(model->rowCount());
}

void MainWindow::on_rechercher2_2_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              player->setMedia(QUrl::fromLocalFile("C:/intgration2/intg/button.wav"));
              player->setVolume(2000);
    ...
    QString identifiant=ui->ln_rechercher_identifiant_2->text();
...
void MainWindow::on_rechercher3_2_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              player->setMedia(QUrl::fromLocalFile("C:/intgration2/intg/button.wav"));
              player->setVolume(2000);
    ...
    QString specialite=ui->ln_rechercher_specialite_2->text();
...
void MainWindow::on_pushButton_19_clicked()
{
    ...
    ui->le_nomt_2->setText("");
    ui->le_identifiant_2->setText("");
    ui->la_specialite_2->setText("");
    ui->le_niveauc_2->setText("");
}
...
void MainWindow::on_pushButton_29_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              ...
              player->play();
    ui->stackedWidget->setCurrentIndex(1);
    QObject::connect(ui->pushButton_29,SIGNAL(clicked()),this,SLOT(pageWidget()) );
}
...
void MainWindow::on_pushButton_30_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              ...
              player->play();
    ui->stackedWidget->setCurrentIndex(1);
    QObject::connect(ui->pushButton_30,SIGNAL(clicked()),this,SLOT(pageWidget()) );
}
...
void MainWindow::on_pushButton_31_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              ...
              player->play();
    ui->stackedWidget->setCurrentIndex(1);
    QObject::connect(ui->pushButton_31,SIGNAL(clicked()),this,SLOT(pageWidget()) );
}
...
void MainWindow::on_pb_acceuil_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              ...
              player->play();
    ui->stackedWidget->setCurrentIndex(1);
    QObject::connect(ui->pb_acceuil,SIGNAL(clicked()),this,SLOT(pageWidget()) );
}
...
void MainWindow::on_pushButton_32_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
              ...
              player->play();
    ui->stackedWidget->setCurrentIndex(1);
     QObject::connect(ui->pushButton_32,SIGNAL(clicked()),this,SLOT(pageWidget()) );
}
