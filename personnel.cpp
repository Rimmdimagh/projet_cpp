...
Personnel::Personnel(int cin,int telephone ,int age,int dureeTravail ,QString nom,QString prenom ,QString adresse ,QString adresseMail,QString message)
     ...
     void Personnel :: settelephone(int telephone)
    {
     ...
     bool Personnel::ajouter()
     {
         ...
         QSqlQuery query;
               query.prepare("INSERT INTO person (CIN,PRENOM,NOM,ADRESSE,ADRESSEMAIL,TELEPHONE,DUREETRAVAIL,AGE,MESSAGE)"
                             "VALUES (:CIN, :PRENOM, :NOM, :ADRESSE ,:ADRESSEMAIL,:TELEPHONE,:DUREETRAVAIL,:AGE,:MESSAGE )");
